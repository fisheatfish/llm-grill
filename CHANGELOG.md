...
- expose aggregate public API and add tests for aggregate function (#14)

## [0.1.3] - 2026-04-06

### Fixed

- update commit parsers to skip CI commits and refine trigger handling
- remove internal field from payload (#12)
